...
```toml
[dependencies]
term-core = { version = "0.1", features = ["s3"] }
# or
term-core = { version = "0.1", features = ["gcs"] }
# or
term-core = { version = "0.1", features = ["azure"] }
# or all cloud providers
term-core = { version = "0.1", features = ["all-cloud"] }
```
...
```rust
use term_core::sources::{AzureAuth, AzureConfig, AzureBlobSource};
