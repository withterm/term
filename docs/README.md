...
- [API Documentation](https://docs.rs/term-core) - Complete Rust API docs
...
3. Follow the writing style guide in [DIATAXIS_QUICK_REFERENCE.md](DIATAXIS_QUICK_REFERENCE.md)
