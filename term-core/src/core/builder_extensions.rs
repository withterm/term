...
impl CheckBuilder {
    ...
    ///
    /// ```rust
    /// use term_core::core::{Check, builder_extensions::StatisticalOptions};
    ...
    /// use term_core::constraints::{FormatType, FormatOptions, UniquenessType, UniquenessOptions, Assertion};
    ///
    /// # use term_core::prelude::*;
