...
//! use term_core::constraints::{CompletenessConstraint, UniquenessConstraint, StatisticalConstraint, StatisticType, Assertion};
//!
...
//! ```rust
//! use term_core::prelude::*;
//! use term_core::core::{Check, builder_extensions::*};
//! use term_core::constraints::{Assertion, FormatOptions, FormatType};
//!
//! # async fn example() -> Result<()> {
...
//!
//! ```rust
//! use term_core::constraints::CustomSqlConstraint;
//!
//! # fn example() -> term_core::prelude::Result<()> {
