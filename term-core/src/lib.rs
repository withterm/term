...
//! use term_core::core::{ValidationSuite, Check, Level, ConstraintStatus, builder_extensions::CompletenessOptions};
...
//!             .statistic("age", term_core::constraints::StatisticType::Min, Assertion::GreaterThanOrEqual(0.0))
//!             .statistic("age", term_core::constraints::StatisticType::Max, Assertion::LessThanOrEqual(120.0))
//!             .build()
//!     )
//!     .build();
//!
...
//!
//! ```rust
//! use term_core::core::{Check, builder_extensions::CompletenessOptions};
//! use term_core::constraints::Assertion;
//!
