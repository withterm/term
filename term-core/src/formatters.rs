...
//!
//! ```rust
//! use term_core::formatters::{ResultFormatter, JsonFormatter, HumanFormatter};
//! use term_core::core::ValidationResult;
//!
...
///
/// ```rust
/// use term_core::formatters::{ResultFormatter, JsonFormatter};
/// use term_core::core::ValidationResult;
///
...
///
/// ```rust
/// use term_core::formatters::{ResultFormatter, JsonFormatter, FormatterConfig};
...
///
/// ```rust
/// use term_core::formatters::{ResultFormatter, MarkdownFormatter};
/// # use term_core::core::{ValidationResult, ValidationReport, ValidationMetrics};
/// # let metrics = ValidationMetrics::new();
/// # let report = ValidationReport::new("test");
/// # let result = ValidationResult::success(metrics, report);
