...
use rand::prelude::*;
use std::sync::Arc;
use term_core::constraints::{Assertion, CompletenessConstraint, FormatType};
                    ...
                    let suite = ValidationSuite::builder("completeness_old")
                        .check(
                            Check::builder("completeness")
                                .constraint(
                                    term_core::constraints::CompletenessConstraint::with_threshold(
                                        "id", 1.0,
                                    ),
                                )
                                .constraint(
                        ...
                        let suite = ValidationSuite::builder("stats_old")
                            .check(
                                Check::builder("statistics")
                                    .constraint(
                                        term_core::constraints::StatisticalConstraint::new(
                                            "age",
                                            term_core::constraints::StatisticType::Min,
                                    ...
                                    .constraint(
                                        term_core::constraints::StatisticalConstraint::new(
                                            "age",
                                            term_core::constraints::StatisticType::Max,
                                    ...
                                    .constraint(
                                        term_core::constraints::StatisticalConstraint::new(
                                            "age",
                                            term_core::constraints::StatisticType::Mean,
                        ...
                        let suite = ValidationSuite::builder("format_old")
                            .check(
                                Check::builder("format")
                                    .constraint(
                                        term_core::constraints::FormatConstraint::regex(
                                            "email",
                    ...
                    let suite = ValidationSuite::builder("complex_old")
                        .check(
                            Check::builder("validation")
                                ...
                                .constraint(
                                    term_core::constraints::UniquenessConstraint::full_uniqueness(
                                        "id", 1.0,
                                    )
                                    .unwrap(),
                                )
                            ...
                            .check(
                                Check::builder("multi_column")
                                    .constraint(CompletenessConstraint::new(
                                        vec!["id", "department"],
                                        term_core::core::ConstraintOptions::new()
                                            .with_operator(term_core::core::LogicalOperator::All)
                                            .with_threshold(1.0),
                                    ))
                                    .constraint(
                                        term_core::constraints::CompletenessConstraint::new(
                                            vec!["email", "age", "salary"],
                                            term_core::core::ConstraintOptions::new()
                                                .with_operator(
                                                    term_core::core::LogicalOperator::Any,
                                                )
                                                .with_threshold(1.0),
                                        ),
                                    )
